        ...
        <div className="hidden lg:flex items-center space-x-4">
          <NavigationMenu>
            <NavigationMenuList className="space-x-2">
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-zyter-purple text-white hover:text-white hover:bg-zyter-purple">Solutions</NavigationMenuTrigger>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-zyter-purple text-white hover:text-white hover:bg-zyter-purple">Customers</NavigationMenuTrigger>
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-4 w-[400px]">
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-zyter-purple text-white hover:text-white hover:bg-zyter-purple">Company</NavigationMenuTrigger>
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-4 w-[400px]">
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink 
                  className={cn(
                    "bg-zyter-purple text-white hover:text-white hover:bg-zyter-purple inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium"
                  )}
                >
                  Career
                </NavigationMenuLink>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-zyter-purple text-white hover:text-white hover:bg-zyter-purple">Learning</NavigationMenuTrigger>
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-4 w-[400px]">
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
